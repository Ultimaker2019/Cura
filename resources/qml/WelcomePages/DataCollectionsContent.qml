...
Item
{
    ...
    Label
    {
        ...
        text: catalog.i18nc("@label", "Help us to improve L-DEVO Cura")
    ...
    Item
    {
        ...
        Column
        {
            ...
            Label
            {
                ...
                anchors.horizontalCenter: parent.horizontalCenter
                horizontalAlignment: Text.AlignHCenter
                text: catalog.i18nc("@text", "L-DEVO Cura collects anonymous data to improve print quality and user experience, including:")
            ...
            Label
            {
                ...
                text:
                {
                    var t = catalog.i18nc("@text", "Data collected by L-DEVO Cura will not contain any personal information.")
