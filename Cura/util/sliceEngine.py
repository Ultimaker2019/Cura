...
class Engine(object):
	...
	def _engineSettings(self, extruderCount):
		settings = {
			...
			'supportSurfaceLineDistance': int(100 * profile.calculateEdgeWidth() * 1000 / profile.getProfileSettingFloat('support_surface_fill_rate')) if (profile.getProfileSettingFloat('support_surface_fill_rate') > 0) else 0,
			'supportSurfaceThickness': int(1000 * profile.getProfileSettingFloat('support_surface_thickness')) if (profile.getProfileSettingFloat('support_surface_thickness') > 0) else 0,
			'supportSurfaceXYDistance': int(1000 * profile.getProfileSettingFloat('support_surface_xy_distance'))if (profile.getProfileSettingFloat('support_surface_xy_distance') > 0) else 0,
			'supportSurfaceZDistance': int(1000 * profile.getProfileSettingFloat('support_surface_z_distance'))if (profile.getProfileSettingFloat('support_surface_z_distance') > 0) else 0,
			'isSupportSurfaceOn': int(1) if (profile.getProfileSetting('add_support_surface') == 'True') else 0,
